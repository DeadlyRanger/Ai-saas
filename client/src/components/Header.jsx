...
const Header = () => {
  return (
   ...
   {/* Left side  */}
    ...
    <p className='my-6 text-[15px] text-gray-500 '>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quis, odit quaerat. <br className='max-sm:hidden' />Nisi itaque neque ratione provident ipsam perspiciatis culpa doloribus,<br className='max-md:hidden' /> illum esse vitae! Voluptas perferendis beatae enim unde, quidem repellendus!</p>
