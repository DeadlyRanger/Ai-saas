...
const Result = () => {
 ...
 <div className='bg-white rounded-lg px-8 py-6 drop-shadow-sm'>
   ...
   <div className='flex flex-col sm:grid grid-cols-2 gap-8'>
      {/* left side */}
      <div>
        <p className='font-sm text-gray-500 mb-2'>Original </p>
        <img  className = "rounded-md border "src={assets.image_w_bg} alt="" />
      </div>
    
    {/* right side */}
    <div className='flex flex-col '>
        <p className='font-sm text-gray-500 mb-2'>Background Removed</p>
         <div className='rounded-md border border-gray-300 h-full relative bg-layer overflow-hidden'>
          <img src={assets.image_wo_bg } alt="" />
            {/* <div className='absolute right-1/2 botton-1/2 transform translate-x-1/2 translate-y-1/2'>
              <div className='border-4 border-violet-600 rounded-full h-12 w-12 border-t-transparent animate-spin mt-10'></div>
 ...
 {/* buttons  */}
    <div className='flex justify-end sm:justify-md-end items-center flex-wrap gap-4 mt-6' >
